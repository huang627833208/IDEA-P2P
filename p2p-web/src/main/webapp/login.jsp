...
<head>
    ...
    <style type="text/css">
        .testBtn-a{display: inline-block;height:30px;line-height:30px;padding:0 10px; border:0; border-radius:0px;color:#fff;background:rgb(65,133,244);cursor: pointer;}
            ...
            <div class="login-cnt clearfix">
                ...
                <div class="login-right">
                    ...
                    <div class="top-txt">
                        动力金融网，便捷的投资平台
                        <br/><br/>
                        加入动力金融网<br/>坐享<span class="historyAverageYearRate">--</span>%历史年化收益
                    </div>
