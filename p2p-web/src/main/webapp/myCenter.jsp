        ...
        <div class="allInvest clearfix">
            <div class="eachInvest invest-tab">
                ...
                <div class="invest-tab-box">
                    <dl>
                        ...
                        <c:if test="${not empty bidInfoList}">
            ...
            <div class="eachInvest invest-tab invest-tab-box">
                ...
                <dl>
                    ...
                    <c:if test="${not empty rechargeRecordList}">
                        <c:forEach items="${rechargeRecordList}" var="rechargeRecord" varStatus="rechargeRecordStatus">
                            <dd>
                                <span class="name">${rechargeRecordStatus.count}</span>
                                ...
                                <span id="preparedLoanStandardTotalIncome" class="profit">
                                    <fmt:formatDate value="${rechargeRecord.rechargeTime}" pattern="yyyy-MM-dd"></fmt:formatDate>
                                </span>
                            </dd>
                        </c:forEach>
                    </c:if>
            ...
            <div class="eachInvest recent-earnings">
                ...
                <dl id="recentearning">
                    ...
                    <c:if test="${not empty incomeRecordList}">
                        <c:forEach items="${incomeRecordList}" var="incomeRecord" varStatus="incomeRecordStatus">
                            <dd>
                                <span class="number" style="text-align:left;">${incomeRecordStatus.count}</span>
